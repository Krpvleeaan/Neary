...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001b32, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001b31, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [765 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x5f81b8b77144ba9e, ; from name: Neary.Mobile
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
	}, ; 267
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x6e2725ea055e37db, ; from name: Neary.Mobile.so
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6e4e0587cb24f12b, ; from name: libaot-Neary.Mobile
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x718d26bda15d8fad, ; from name: aot-Neary.Mobile
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8a9a85115f28ebd4, ; from name: aot-Neary.Mobile.dll.so
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb79fdfa814e3aa8e, ; from name: libaot-Neary.Mobile.so
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xba3ee3664d90d342, ; from name: aot-Neary.Mobile.so
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xccb193de08f8708d, ; from name: Neary.Mobile.dll.so
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xeafb3dcdab6ee9f4, ; from name: libaot-Neary.Mobile.dll.so
		i64 u0xeafb3dcdab6ee9f4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Neary.Mobile.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [18 x i8] c"com.neary.tracker\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [27 x i8] c"libaot-Neary.Mobile.dll.so\00", align 16
